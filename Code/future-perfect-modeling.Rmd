...
# Success Prediction Form Skeleton 
```{r}
is_Created_night = 
is_Created_afternoon = 
is_Created_evening = 
...
This can be used to build a model which will predict the likelihood of a post going viral. This might be useful if ERASE decides to focus, specifically, on 
```{r}
# isSuccessful = 
# isNotSuccessful 
```
